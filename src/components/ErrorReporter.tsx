            ...
            {process.env.NODE_ENV === "development" && (
              <details className="mt-4 text-left">
                <summary className="cursor-pointer text-sm text-muted-foreground hover:text-foreground">
                  ...
                  <div className="mt-2 text-xs bg-muted p-4 rounded-xl overflow-auto font-mono whitespace-pre-wrap">
                    {error.message}
                    {error.stack && (
                      <div className="mt-4 pt-4 border-t border-muted-foreground/10 text-muted-foreground">
                        {error.stack}
                      </div>
                    )}
                    {error.digest && (
